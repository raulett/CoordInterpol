...
for root, dirs, files in os.walk(qgis_plugins_path + '\\RousettusTool\\', topdown=False):
    for file in files:
...
for file in files_to_copy:
    target_path = file.replace(root_path, qgis_plugins_path + '\\RousettusTool\\')
    if not os.path.exists(os.path.dirname(target_path)):
        os.mkdir(os.path.dirname(target_path))
    shutil.copy(file, target_path)


for root, dirs, files in os.walk(deploy_path + '\\RousettusTool\\', topdown=False):
    for file in files:
        curpath = os.path.join(root, file)
        os.remove(curpath)
...
for file in files_to_copy:
    target_path = file.replace(root_path, deploy_path + '\\RousettusTool\\')
    if not os.path.exists(os.path.dirname(target_path)):
        os.mkdir(os.path.dirname(target_path))
    shutil.copy(file, target_path)
